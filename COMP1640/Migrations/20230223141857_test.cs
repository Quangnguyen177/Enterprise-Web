    ...
    public partial class test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "A", "937f5e06-571d-4b3e-9ef4-fbc19d699e23", "Administrator", "Administrator" },
                    { "B", "a0cfd1be-6061-4e21-a68b-9ae8a039c846", "Staff", "Staff" },
                    { "C", "615876e4-e283-470c-97cc-7cec275781a8", "Quality Assurance Manager", "Quality Assurance Manager" },
                    { "D", "b604f849-6c54-4603-b1e7-2709c8d362ae", "Quality Assurance Coordinator", "Quality Assurance Coordinator" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "Somewhere in the big gray sky", "", "7ed81062-a914-4a52-840b-169ca321aafe", "1", new DateTime(2002, 3, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", false, "Male", false, null, "Truong Dep Zai", null, "admin@gmail.com", "AQAAAAEAACcQAAAAEIyYKvAmZHQ4WW4zUiXdZEfRuJOjYQPMYaAJb5cWDpnONKVx2iY3KPK9IPYHMJYaow==", "0983337621", false, "219134af-791b-4668-834b-686cb6c6c7b9", false, "Truong" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "Avatar", "ConcurrencyStamp", "DepId", "DoB", "Email", "EmailConfirmed", "Gender", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "2", 0, "Somewhere in the big gray sky", "", "4e8e9074-837e-4dea-9513-cad708bf183b", "1", new DateTime(2002, 8, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "staff1@gmail.com", false, "Male", false, null, "Duke Mike The", null, "staff1@gmail.com", "AQAAAAEAACcQAAAAELy63MnQEHx+94B+ZrW4iF5C8LXHf2P+sE4vqXiqWwSA+2spxQ808aGqdaB1/83n0A==", "0329226528", false, "1d749c00-3327-4aaa-a731-f05e284652a9", false, "Duke Mike The" });
