        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdeaId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Documents", x => x.DocId);
                    table.ForeignKey(
                        name: "FK_Documents_Ideas_IdeaId1",
                        column: x => x.IdeaId1,
                        principalTable: "Ideas",
                        principalColumn: "IdeaId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "A", "c46bdbb2-83fe-44ed-af9b-37249dc491f7", "Administrator", "Administrator" },
                    { "B", "e2c94e87-9610-44d2-8c1d-5abad182df9a", "Staff", "Staff" },
                    { "C", "ea3dc07a-ca1e-474c-8c42-117a70d809f0", "Quality Assurance Manager", "Quality Assurance Manager" },
                    { "D", "5e3a4c14-3588-41e0-93e2-fb70ed1efb14", "Quality Assurance Coordinator", "Quality Assurance Coordinator" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Documents",
                columns: new[] { "DocId", "IdeaId", "IdeaId1", "doc_content", "doc_type" },
                values: new object[] { 1, 1, null, "This is a word or pdf, it can be a file", "Word" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "Somewhere in the big gray sky", "", "0da9aea5-ba2e-4340-9cd7-582ac5150b2a", "1", new DateTime(2002, 3, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", false, "Male", false, null, "Truong Dep Zai", null, "admin@gmail.com", "AQAAAAEAACcQAAAAEFfvPrM3Ar+aMqp2HTfZdKkhv4D+gRfs/8jf4/AJ4TsWBqRS4WVmMz2LLGml+kvTUQ==", "0983337621", false, "0db665a1-8fa0-4388-a822-cb567dcceef1", false, "Truong" });
