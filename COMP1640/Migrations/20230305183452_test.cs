    ...
    public partial class test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "A", "4a22016b-bbcb-47f6-aba3-56e302b8d1bb", "Administrator", "Administrator" },
                    { "B", "3faef791-d2d0-478d-a3b2-675d7387f8ea", "Staff", "Staff" },
                    { "C", "d5127dc3-36e1-4e2e-8b42-792916e64371", "Quality Assurance Manager", "Quality Assurance Manager" },
                    { "D", "362e2d7b-f028-4b35-99bb-be3cf5219ec1", "Quality Assurance Coordinator", "Quality Assurance Coordinator" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "Somewhere in the big gray sky", "", "4ee3fedf-ad55-495a-86ea-1248ee174625", "1", new DateTime(2002, 3, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", false, "Male", false, null, "Truong Dep Zai", null, "admin@gmail.com", "AQAAAAEAACcQAAAAEAkqDaTOpAyC5P5bySdbsz+ADznorUsP2cmYFUcUsSOenkLirfZim4FF9fhCCnwNVA==", "0983337621", false, "90bf08f7-c7c4-4cb6-b101-e9acc85574b3", false, "Truong" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "Avatar", "ConcurrencyStamp", "DepId", "DoB", "Email", "EmailConfirmed", "Gender", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "2", 0, "Somewhere in the big gray sky", "", "c705a779-6c58-4111-9f1b-ba05878c4d02", "1", new DateTime(2002, 8, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "staff1@gmail.com", false, "Male", false, null, "Duke Mike The", null, "staff1@gmail.com", "AQAAAAEAACcQAAAAEMbrUspxvfVJIPwil8ASrCIhzPmGpMnmTsOc3YE8DP3OVT2rJfUX4y3NYE8B/fSusQ==", "0329226528", false, "ebcfb62d-f8b5-4508-b061-9d7f500489fd", false, "Duke Mike The" });
