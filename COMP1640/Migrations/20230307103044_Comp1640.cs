    ...
    public partial class Comp1640 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "A", "4c5bbe20-c2e9-4ee2-ba2f-f15a95516af3", "Administrator", "Administrator" },
                    { "B", "68028ecc-6d68-4c09-8cc6-0d831dc0f26b", "Staff", "Staff" },
                    { "C", "eeb00c06-51ff-4c15-bd1d-78eb0f7f638f", "Quality Assurance Manager", "Quality Assurance Manager" },
                    { "D", "0eaacac9-be23-478a-8c6c-40c7aa654c8f", "Quality Assurance Coordinator", "Quality Assurance Coordinator" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "Somewhere in the big gray sky", "", "3f01131f-73da-4c4f-87fc-a7e157a654a5", "1", new DateTime(2002, 3, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", false, "Male", false, null, "Truong Dep Zai", null, "admin@gmail.com", "AQAAAAEAACcQAAAAEGqWGOKzihttGhrdDj1d8j11nDKpcTlUqB23cgdh6c7PQrOZeWzAcvcrV/8rU2wnhA==", "0983337621", false, "116cce52-66c7-447b-8532-77d37152c802", false, "Truong" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "Avatar", "ConcurrencyStamp", "DepId", "DoB", "Email", "EmailConfirmed", "Gender", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "2", 0, "Somewhere in the big gray sky", "", "9fc282de-26c7-4ee3-9ade-05794e413bf5", "1", new DateTime(2002, 8, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "staff1@gmail.com", false, "Male", false, null, "Duke Mike The", null, "staff1@gmail.com", "AQAAAAEAACcQAAAAEBwiG67AdUHP6+iCS2Ew059FQpUidxvFuQlHAkEeycNf0+pFZI6sErKhqPpGCn58vw==", "0329226528", false, "c3c3dfb2-e16a-4b51-82f5-ee44c8c09e86", false, "Duke Mike The" });
